...
class TestFileSystem(object):
    ...
    def test_filesystem_not_implemented(self):
        FileSystem.new('foo', mock.Mock(), 'source_dir')

    @patch('kiwi.filesystem.FileSystemExt2')
    def test_filesystem_ext2(self, mock_ext2):
        provider = mock.Mock()
        FileSystem.new('ext2', provider, 'source_dir')
    ...
    def test_filesystem_ext3(self, mock_ext3):
        provider = mock.Mock()
        FileSystem.new('ext3', provider, 'source_dir')
    ...
    def test_filesystem_ext4(self, mock_ext4):
        provider = mock.Mock()
        FileSystem.new('ext4', provider, 'source_dir')
    ...
    def test_filesystem_xfs(self, mock_xfs):
        provider = mock.Mock()
        FileSystem.new('xfs', provider, 'source_dir')
    ...
    def test_filesystem_btrfs(self, mock_btrfs):
        provider = mock.Mock()
        FileSystem.new('btrfs', provider, 'source_dir')
    ...
    def test_filesystem_fat16(self, mock_fat16):
        provider = mock.Mock()
        FileSystem.new('fat16', provider, 'source_dir')
    ...
    def test_filesystem_fat32(self, mock_fat32):
        provider = mock.Mock()
        FileSystem.new('fat32', provider, 'source_dir')
    ...
    def test_filesystem_squashfs(self, mock_squashfs):
        provider = mock.Mock()
        FileSystem.new('squashfs', provider, 'source_dir')
