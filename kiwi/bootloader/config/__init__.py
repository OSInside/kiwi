...
if TYPE_CHECKING:  # pragma: nocover
    ...
    from kiwi.bootloader.config.iso_s390x import BootLoaderIsoS390x
...
@overload
def create_boot_loader_config(
    *, name: Literal["iso_s390x"], xml_state: object, root_dir: str,
    boot_dir: str = None, custom_args: Dict = None
) -> "BootLoaderIsoS390x":
    ...  # pragma: nocover
...
def create_boot_loader_config(
    *, name: str, xml_state: object, root_dir: str,
    boot_dir: str = None, custom_args: Dict = None
) -> "Union[BootLoaderConfigGrub2, BootLoaderSystemdBoot, BootLoaderZipl, BootLoaderConfigCustom, BootLoaderIsoS390x]":
    ...
    if name == "iso_s390x":
        from kiwi.bootloader.config.iso_s390x import BootLoaderIsoS390x
        return BootLoaderIsoS390x(xml_state, root_dir, boot_dir, custom_args)
    if name == "custom":
        from kiwi.bootloader.config.custom import BootLoaderConfigCustom
